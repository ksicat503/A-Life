...
class Carnivores:
    ...
    def move(self):
        ...
        Is limited by the environmental grid, and instances of Carnivore
        objects can occupy the same position.
        """
        if not self.is_alive:
            return

        self.x_pos = self.x_pos + random.randint(-10, 10)
        self.y_pos = self.y_pos + random.randint(-10, 10)
    ...
    def reproduction_chance(self):
        ...
        self.offspring_chance probability that a new Carnivores instance of
